...
export default function OverviewHero3D({
  ...
  return (
    <div className="relative w-full h-full min-h-[380px] sm:min-h-[420px] lg:min-h-[460px] select-none">
      ...
      <div className="absolute top-4 left-8 sm:top-6 sm:left-12 flex items-center space-x-2.5 px-3.5 py-1.5 rounded-2xl gs-glass-badge transition-transform hover:scale-105 z-10">
        <div className="w-6 h-6 rounded-xl bg-[#FFF7E4] text-[#E5A72D] flex items-center justify-center text-xs flex-shrink-0">
          <FaIcon name="solar" />
        </div>
        <div>
      ...
      <div className="absolute top-4 right-4 sm:top-6 sm:right-8 flex items-center space-x-2.5 px-3.5 py-1.5 rounded-2xl gs-glass-badge transition-transform hover:scale-105 z-10">
        <div className="w-6 h-6 rounded-xl bg-[#EDF3FD] text-[#3C78CC] flex items-center justify-center text-xs flex-shrink-0">
          <FaIcon name="grid" />
        </div>
        <div>
          <div className="font-changa text-sm sm:text-base font-normal text-[#17221D] leading-tight">
      ...
      <div className="absolute bottom-4 left-8 sm:bottom-6 sm:left-12 flex items-center space-x-2.5 px-3.5 py-1.5 rounded-2xl gs-glass-badge transition-transform hover:scale-105 z-10">
        <div className="w-6 h-6 rounded-xl bg-[#E8F6EE] text-[#1E9B68] flex items-center justify-center text-xs flex-shrink-0">
          <FaIcon name="home" />
        </div>
        <div>
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 sm:bottom-6 flex items-center space-x-2.5 px-3.5 py-1.5 rounded-2xl gs-glass-badge transition-transform hover:scale-105 z-20 whitespace-nowrap">
        <div className="w-6 h-6 rounded-xl bg-[#E8F6EE] text-[#1E9B68] flex items-center justify-center text-xs flex-shrink-0">
          <FaIcon name="battery" />
        </div>
        <div>
      ...
      <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-8 flex items-center space-x-2.5 px-3.5 py-1.5 rounded-2xl gs-glass-badge transition-transform hover:scale-105 z-10">
