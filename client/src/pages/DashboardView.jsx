...
export default function DashboardView({ onOpenDemoModal }) {
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-12 select-none animate-fadeIn">
      ...
      {/* 🌟 1. HERO SECTION (Grand 3D Isometric Microgrid Composition) */}
      <div className="relative overflow-hidden rounded-3xl bg-white border border-[rgba(23,34,29,0.08)] p-6 sm:p-8 lg:p-10 shadow-xs">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          {/* Right Column: 3D Isometric Microgrid Scene + 5 Floating Badges (6 cols) */}
      ...
      <div className="rounded-2xl bg-white border border-[rgba(23,34,29,0.08)] p-5 sm:p-6 shadow-xs grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 items-center">
        ...
        <div>
          ...
          <div className="text-2xl sm:text-3xl font-black text-[#1E9B68] mt-0.5">
        ...
        <div>
          ...
          <div className="text-2xl sm:text-3xl font-black text-[#17221D] mt-0.5">
        ...
        <div className="flex flex-col justify-between items-end space-y-2">
          {/* Subtle Green Waveform Sparkline */}
        ...
        <div className="lg:col-span-4 rounded-2xl bg-white border border-[rgba(23,34,29,0.08)] p-5 shadow-xs flex flex-col justify-between space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2 text-center p-2.5 rounded-xl bg-[#F6F7F4] border border-[rgba(23,34,29,0.06)]">
            <div className="space-y-0.5">
              ...
              <div className="text-sm font-extrabold font-mono text-[#DDA12A]">
            ...
            <div className="space-y-0.5 border-x border-[rgba(23,34,29,0.08)]">
              ...
              <div className="text-sm font-extrabold font-mono text-[#17221D]">
            ...
            <div className="space-y-0.5">
              ...
              <div className="text-sm font-extrabold font-mono text-[#1E9B68]">
        ...
        <div className="lg:col-span-4 rounded-2xl bg-white border border-[rgba(23,34,29,0.08)] p-5 shadow-xs flex flex-col justify-between space-y-3">
          ...
          <div className="grid grid-cols-4 gap-2 text-center py-2">
            <div className="flex flex-col items-center">
              ...
              <div className="text-base sm:text-lg font-black text-[#17221D]">84%</div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-base sm:text-lg font-black text-[#1E9B68]">2.0 kWh</div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-base sm:text-lg font-black text-[#17221D]">₹4.48</div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-base sm:text-lg font-black text-[#17221D]">32%</div>
